  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col"> 
        ...
        <h2 className="h3-bold md:h2-bold pt-s sm:pt-12">Create A New Account</h2>
        <p className="text-light-3 small-medium md:base-regular mt-2">To use this App enter your acct. details</p>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
        ...
        <Button type="submit" className="shad-button_primary">{isCreatingAccount ? (
          <div className="flex-center gatp-2">
           <Loader /> Loading...
          </div>
        ) : "Sign up"}</Button>
